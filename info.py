...
# Bot information
SESSION = environ.get('SESSION', 'ShuvoBot')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002451136723').split()]  # For Multiple Id Use One Space Between Each.
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/S_MovieChannel/235') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
